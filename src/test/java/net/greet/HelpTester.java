...
public class HelpTester {
    @Test
    void shouldReturnHelpMenu() {
        String helpMenu = Help.helpMenu();

        assertEquals(("                          ☶ Welcome to the Help page:\n\n" +
                ...
                "☉ Help     - command: This command takes you to this current page."), helpMenu);
    }
